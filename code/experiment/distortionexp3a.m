...
% 0,2 or 4 distorted flankers. One frequency and 7 amplitudes are tested.
% 
% params: 
% - subject code:   identification of the observer
% - number of distorted flankers: 0,2,4 flankers are distorted additionally
%   to the distorted target
% - distortiontype: 
...
if distflankers == 2
    imPath = fullfile(filepathToHere, '../stimuli/exp3img2flankersdistorted/distorted');
elseif distflankers == 4
    imPath = fullfile(filepathToHere, '../stimuli/exp3img4flankersdistorted/distorted');
elseif distflankers == 0
    imPath = fullfile(filepathToHere, '../stimuli/exp3img0flankersdistorted/distorted');
else
    fclose('all')
...
datafilename = fullfile(dataPath, strcat(num2str(distflankers), 'distflanker_distortionData_', flankedtype, '_', distortiontype, '_sub_',subj,'_session_',num2str(session),'.csv')); % name of data file to write to
